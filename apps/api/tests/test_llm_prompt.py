...
# =================================================================
# Phase 2 polish (2026-04-27, A 案撤回): transport_mode 関連 test は削除済み。
# 旧 test 群（_pack_with_transport / public_transit_only / mode_context_section_order
# 等）は本番 Run 13 で「公共交通機関のみ」モードが NoFeasibleTransitError を誘発した
# ため Backend 側の配線を完全削除したのに合わせて撤去。Pydantic 側の deprecated
# field の振る舞いは test_schemas.py の backward compat test で担保する。
# =================================================================
